...
df1 = pd.read_csv("v1/Level 3/data_penjualan.csv")
...
df2_sorted.to_csv("v1/Level 3/Ringkasan Penjualan/ringkasa_penjualan_per_produk.csv",index=False)
df3.to_csv("v1/Level 3/Ringkasan Penjualan/ringkasa_penjualan_per_bulan.csv",index=False)
